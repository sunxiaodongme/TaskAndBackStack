package com.example.sunxiaodong.taskandbackstack.standard;
 ...
 * 启动模式为：standard
 */
public class StandardOneActivity extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = StandardOneActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.standard_one_activity);
        initView();
